...
export function MarkReceivedModal({ project, client, open, onClose, onSuccess }: Props) {
  ...
  const [amount, setAmount] = useState(project.expected_amount != null ? String(project.expected_amount) : '')
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                disabled={loading}
                className={currency === 'BRL' ? 'pl-11' : 'pl-9'}
              />
            </div>
            {project.expected_amount != null && project.expected_amount !== parseFloat(amount || '0') && !isNaN(parseFloat(amount)) && (
